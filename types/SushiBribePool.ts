...
export interface SushiBribePoolInterface extends ethers.utils.Interface {
  functions: {
...
export interface SushiBribePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiBribePoolInterface;
